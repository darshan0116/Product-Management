import { Button, Drawer, Form, Input, message, Upload, Select } from "antd";
          ...
          <Form layout="vertical" onFinish={handleFinish} form={form}>
            ...
            <Form.Item
              ...
              rules={[
                ...
                {
                  pattern: /^\d+(\.\d{1,2})?$/,
                  message: "Amount must be a valid number (99.99)",
                },
              ]}
            >
            ...
            <Form.Item
              ...
              rules={[
                ...
                },
                {
                  ...
                  type: "string",
                  message:
                    "Product description must be between 3 and 200 characters",
                },
              ]}
            >
